...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\TimeForm' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\TimeForm']) ? $this->services['AppBundle\Form\TimeForm'] : $this->services['AppBundle\Form\TimeForm'] = new \AppBundle\Form\TimeForm()) && false ?: '_'};
